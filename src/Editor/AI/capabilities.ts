  ...
  textEffects: [
    ...
    },
    {
      ...
      settings: [
        ...
        { key: "startPercent", type: "number", description: "Normalized effect start within the item duration." },
        { key: "endPercent", type: "number", description: "Normalized effect end within the item duration." },
        { key: "distance", type: "number", description: "Floating travel distance. Negative values move opposite the chosen direction." },
        { key: "preStartSeconds", type: "number", description: "Allow motion to begin before the lyric start time." },
        { key: "speed", type: "number", description: "Floating motion speed. Negative values slow the drift curve while positive values accelerate it." },
  ...
  elements: [
    {
      key: "visualizer",
      label: "Visualizer",
      description: "An audio-reactive background element that can render as the classic radial visualizer or an aurora-style side glow.",
      defaults: DEFAULT_VISUALIZER_SETTING,
      settings: [
        { key: "mode", type: "enum", description: "Visualizer render mode.", allowedValues: ["classic", "aurora"] },
        ...
        { key: "globalAudioReactiveFocus", type: "number", description: "Global bass-to-treble emphasis applied across all stops." },
         { key: "fillRadialGradientColorStops", type: "array", description: "Ordered color stops with beat-sync intensity values, per-stop audio focus, and optional per-stop x/y placement, shape, reach, thickness, rotation, glow, contrast, reactive threshold, expansion, and motion." },
        { key: "auroraShape", type: "enum", description: "Aurora shape profile.", allowedValues: ["beam", "ribbon", "bloom"] },
        { key: "auroraOriginX", type: "number", description: "Aurora origin horizontal position." },
        { key: "auroraOriginY", type: "number", description: "Aurora origin vertical position." },
        { key: "auroraWidth", type: "number", description: "Aurora reach across the frame." },
        { key: "auroraHeight", type: "number", description: "Aurora thickness." },
        { key: "auroraRotation", type: "number", description: "Aurora angle in degrees." },
        { key: "auroraGlowIntensity", type: "number", description: "Aurora glow brightness." },
        { key: "auroraContrast", type: "number", description: "Aurora contrast and high-contrast core strength." },
        { key: "auroraReactiveThreshold", type: "number", description: "Audio level required before the aurora begins glowing." },
        { key: "auroraExpansionAmount", type: "number", description: "How aggressively the aurora expands once it passes the reactive threshold." },
        { key: "auroraMotionAmount", type: "number", description: "Aurora drift amount." },
    ...
    },
    {
      ...
      settings: [
        ...
        { key: "fields", type: "array", description: "Array of light fields with color, position, radius, rotation, opacity, motionAmount, beatReactiveIntensity, and beatReactiveFocus (0 bass, 0.5 mid, 1 treble)." },
      ],
    },
    {
      key: "grain",
