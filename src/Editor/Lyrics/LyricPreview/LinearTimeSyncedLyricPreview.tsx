...
const EDGE_FADE_MASK =
  "linear-gradient(to bottom, transparent 0%, rgba(0,0,0,0.22) 5%, rgba(0,0,0,0.62) 10%, black 17%, black 58%, rgba(0,0,0,0.92) 64%, rgba(0,0,0,0.74) 71%, rgba(0,0,0,0.48) 79%, rgba(0,0,0,0.22) 87%, transparent 100%)";
